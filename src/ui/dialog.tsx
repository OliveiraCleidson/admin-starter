...
export const dialogContentStaticClasses =
  "grid gap-4 border bg-background text-card-foreground p-3 shadow-lg rounded-xl";

export const dialogPrimitiveCloseStaticClasses =
  "absolute right-4 top-4 rounded-lg opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-neutral-200 data-[state=open]:text-neutral-600";
...
export const dialogTitleStaticClasses =
  "text-3xl font-bold tracking-wide font-display";
